...
import { CreditCard, Wallet, Check, Shield, Download, ChevronRight, AlertCircle, Info } from "lucide-react"
...
const handleSubmit=()=>{
  ...
  const validateForm = () => {
    ...
    if (!cardName) {
      errors.cardName = "يرجى إدخال اسم حامل البطاقة"
    }
  ...
  if (paymentMethod === "paypal") {
    ...
    setTimeout(() => {
      ...
      setPaymentState("OTP")
      // Focus the first OTP input when the OTP screen appears
      setTimeout(() => {
  ...
  const renderProgressIndicator = () => (
    <div className="flex items-center justify-between mb-6 px-2">
      <div className="flex flex-col items-center">
        <div
          className={`w-8 h-8 rounded-full flex items-center justify-center ${paymentState === "FORM" ? "bg-primary text-primary-foreground" : "bg-primary text-primary-foreground"}`}
        >
          1
        </div>
      ...
      <div className="flex flex-col items-center">
        <div
          className={`w-8 h-8 rounded-full flex items-center justify-center ${paymentState === "OTP" ? "bg-primary text-primary-foreground" : paymentState === "SUCCESS" ? "bg-primary text-primary-foreground" : "bg-muted text-muted-foreground"}`}
        >
          2
        </div>
      ...
      <div className="flex flex-col items-center">
        <div
          className={`w-8 h-8 rounded-full flex items-center justify-center ${paymentState === "SUCCESS" ? "bg-primary text-primary-foreground" : "bg-muted text-muted-foreground"}`}
        >
          3
        </div>
          ...
          <RadioGroup value={paymentMethod || ""} onValueChange={setPaymentMethod} className="grid gap-4">
            <div className="grid gap-6">
              <div className="relative">
                <div
                  className={`absolute inset-0 rounded-lg transition-all duration-200 ${paymentMethod === "card" ? "ring-2 ring-primary" : ""}`}
                ></div>
...
maxLength={4}
              ...
              <div className="relative">
                <div
                  className={`absolute inset-0 rounded-lg transition-all duration-200 ${paymentMethod === "paypal" ? "ring-2 ring-primary" : ""}`}
                ></div>
                <div className="flex items-center space-x-2 relative">
  ...
  const renderOtpVerification = () => (
    <>
      <CardHeader className="space-y-1 pb-2">
        <CardTitle className="text-2xl font-bold">التحقق من الدفع</CardTitle>
        <CardDescription>أدخل رمز التحقق المكون من 6 أرقام المرسل إلى هاتفك</CardDescription>
      </CardHeader>
      <CardContent className="space-y-6">
        {renderProgressIndicator()}
  ...
  const renderSuccess = () => (
    <>
      <CardHeader className="space-y-1 pb-2">
        ...
        <CardTitle className="text-2xl font-bold text-center">تمت عملية الدفع بنجاح</CardTitle>
        <CardDescription className="text-center">شكراً لك! تم تأكيد عملية الدفع وإتمامها بنجاح</CardDescription>
      </CardHeader>
      <CardContent className="space-y-6">
        {renderProgressIndicator()}
        ...
        <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-4">
          <div className="flex justify-between items-center mb-2">
            <span className="text-sm text-green-700">حالة الدفع:</span>
            <Badge variant="outline" className="bg-green-100 text-green-700 border-green-200">
              تم الدفع
            </Badge>
          </div>
          <div className="flex justify-between items-center">
            <span className="text-sm text-green-700">تاريخ العملية:</span>
        ...
        <div className="border rounded-lg p-4 bg-muted/30">
          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-between mb-2">
              ...
              <span className="font-medium">{paymentMethod === "card" ? "بطاقة ائتمان" : "كي نت"}</span>
            </div>
        ...
        <div className="border border-dashed rounded-lg p-4 bg-muted/10">
          <div className="flex justify-between items-center mb-4">
            <h3 className="font-medium">الإيصال الإلكتروني</h3>
          ...
          <div className="space-y-2">
            ...
            <div className="flex justify-between text-sm">
              <span>الشحن</span>
              <span>
                {orderDetails.shipping} {currency === "sar" ? "د.ك" : "$"}
              </span>
            </div>
            <div className="flex justify-between text-sm">
              <span>الضريبة</span>
              <span>
                {orderDetails.tax} {currency === "sar" ? "د.ك" : "$"}
              </span>
            </div>
            <Separator className="my-2" />
            <div className="flex justify-between font-bold">
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gradient-to-b from-gray-50 to-gray-100" dir="rtl">
      <Card className="w-full max-w-md shadow-xl border-0 overflow-hidden">
        ...
        {paymentState === "OTP" && renderOtpVerification()}
