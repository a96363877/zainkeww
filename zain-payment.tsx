      ...
      <div className="p-5">
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
          ...
          <div className="relative mb-4">
            <div className="bg-gradient-to-r from-[#d13c8c] to-[#ff6b9d] rounded-lg p-3  text-center relative overflow-hidden animate-pulse-glow">
              <div className="absolute inset-0 bg-black/10 backdrop-blur-sm animate-shimmer"></div>
